...
# learning
parser.add_argument('-lr', type=float, default=0.00859, help='comma-separated learning rates to use for training')
parser.add_argument('-weight-decay', type=float, default=0.00019, help='comma-separated weight decays to use for training')
...
parser.add_argument('-threshold', type=float, default=0.10, help='model type (LR or CNN) [default: LR]')
