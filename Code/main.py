...
parser.add_argument('-plot-interval',  type=int, default=1000,   help='how many steps to wait before plotting training status [default: 1]')
...
"""os.path.join(
        args.plot_dir, datetime.datetime.now().strftime('%Y-%m-%d_%H-%M-%S') + '_' + args.identifier)
"""
